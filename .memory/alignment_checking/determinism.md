...
**Order alignment:** N/A — different structures by design (Core#5 SDK Protection → Py#6, TS#3; languages have Forbidden Operations which Core covers in Sources)
...
- Safe Builtin Alternatives intentionally Python-only (TS V8 sandbox handles automatically)
