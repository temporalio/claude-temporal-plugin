...
All TODO/DEL/BUG items have been implemented. See `.edits.md` files in `references/typescript/` and `references/python/` for details of changes made.
...
**File paths:** All files are relative to `references/` (e.g., `patterns.md` refers to `references/typescript/patterns.md` and `references/python/patterns.md`). Core files are in `references/core/`.
